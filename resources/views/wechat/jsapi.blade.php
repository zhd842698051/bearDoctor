...
//①、获取用户openid
$tools = new JsApiPay();
$openId = $tools->GetOpenid("/wechat?money=".$money);
...
$input->SetNotify_url("http://www.bshop.com/notify");
		...
		WeixinJSBridge.invoke(
			...
			function(res){
				...
				if (res.err_msg == "get_brand_wcpay_request:ok") { //如果微信支付成功  
                    // message: "微信支付成功!"  
                    alert("支付成功！");  
                    location.href="/order";//你成功后要跳转的页面或控制器  
...
<body>
    <br/>
    <font color="#9ACD32"><b>该笔订单支付金额为<span style="color:#f00;font-size:50px"><?php $sum=$money/100; ?>{{$sum}}</span>元</b></font><br/><br/>
	<div align="center">
