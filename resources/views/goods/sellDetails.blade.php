        	...
        	<div class="lim_time">
                ...
                <table border="0" style="width:100%; margin-bottom:50px;" cellspacing="0" cellpadding="0">
                  <tr valign="top">
                    ...
                    <td width="525" align="center" style="border-left:1px solid #eaeaea;"><img src="{{asset('images')}}/tm_big.jpg" width="460" height="460" /></td>
                  </tr>
                </table>
            </div>
            ...
            <div class="des_border" id="p_comment">
                ...
                <table border="0" class="jud_tab" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <td width="290" class="jud_bg">您可对已购买商品进行评价<br /><a href="#"><img src="{{asset('images')}}/btn_jud.gif" /></a></td>
                  </tr>
                </table>
