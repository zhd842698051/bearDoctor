...
<div class="i_bg">
    ...
    <div class="content">
        ...
        <div id="tsShopContainer">
            ...
            <img class="MagicZoomLoading" width="16" height="16" src="{{asset('images')}}/loading.gif" alt="Loading..." />               
        </div>
        ...
        <div class="s_brand">
            <div class="s_brand_img"><img src="{{asset('images')}}/sbrand.jpg" width="188" height="132" /></div>
    ...
    <div class="content mar_20">
        ...
        <div class="l_list">            
            <div class="des_border">
                ...
                <div class="team_list">
                    <div class="img"><a href="#"><img src="{{asset('images')}}/mat_1.jpg" width="160" height="140" /></a></div>
                ...
                <div class="team_icon"><img src="{{asset('images')}}/jia_b.gif" /></div>
                <div class="team_list">
                    <div class="img"><a href="#"><img src="{{asset('images')}}/mat_2.jpg" width="160" height="140" /></a></div>
                ...
                <div class="team_icon"><img src="{{asset('images')}}/jia_b.gif" /></div>
                <div class="team_list">
                    <div class="img"><a href="#"><img src="{{asset('images')}}/mat_3.jpg" width="160" height="140" /></a></div>
                    <div class="name"><a href="#">香奈儿邂逅清新淡香水50ml</a></div>
                    <div class="price">
                        <div class="checkbox"><input type="checkbox" name="zuhe" checked="checked" /></div>
                        <font>￥<span>749.00</span></font> &nbsp; 18R
                ...
                <div class="team_icon"><img src="{{asset('images')}}/equl.gif" /></div>
                <div class="team_sum">
                    套餐价：￥<span>1517</span><br />
                    <input type="text" value="1" class="sum_ipt" /><br />
                    <a href="#"><img src="{{asset('images')}}/z_buy.gif" /></a> 
                </div>
            ...
            <div class="des_border" id="p_details">
                ...
                <div class="des_con">
                    <table border="0" align="center" style="width:745px; font-size:14px; font-family:'宋体';" cellspacing="0" cellpadding="0">
                      <tr>
                        <td width="265"><img src="{{asset('images')}}/de1.jpg" width="206" height="412" /></td>
                        <td>
                            <b>迪奥真我香水(Q版)</b><br />
                            【商品规格】：5ml<br />
                            【商品质地】：液体<br />
                    ...
                    <p align="center">
                    <img src="{{asset('images')}}/de2.jpg" width="746" height="425" /><br /><br />
                    <img src="{{asset('images')}}/de3.jpg" width="750" height="417" /><br /><br />
                    <img src="{{asset('images')}}/de4.jpg" width="750" height="409" /><br /><br />
                    <img src="{{asset('images')}}/de5.jpg" width="750" height="409" />
                    </p>
            ...
            <div class="des_border" id="p_comment">
                ...
                <table border="0" class="jud_tab" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <td width="300">
                        <table border="0" style="width:100%;" cellspacing="0" cellpadding="0">
                          <tr>
                            ...
                            <td><img src="{{asset('images')}}/pl.gif" align="absmiddle" /></td>
                          </tr>
                          <tr>
                    ...
                    <td class="jud_bg">您可对已购买商品进行评价<br /><a href="#"><img src="{{asset('images')}}/btn_jud.gif" /></a></td>
                  </tr>
                </table>
                ...
                <table border="0" class="jud_list" style="width:100%; margin-top:30px;" cellspacing="0" cellpadding="0">
                  <tr valign="top">
                    <td width="160"><img src="{{asset('images')}}/peo1.jpg" width="20" height="20" align="absmiddle" />&nbsp;向死而生</td>
                    <td width="180">
                  ...
                  <tr valign="top">
                    <td width="160"><img src="{{asset('images')}}/peo2.jpg" width="20" height="20" align="absmiddle" />&nbsp;就是这么想的</td>
                    <td width="180">
                        颜色分类：<font color="#999999">粉色</font> <br />
                        型号：<font color="#999999">50ml</font>
                    </td>
                  ...
                  <tr valign="top">
                    <td width="160"><img src="{{asset('images')}}/peo3.jpg" width="20" height="20" align="absmiddle" />&nbsp;墨镜墨镜</td>
                    <td width="180">
                        颜色分类：<font color="#999999">粉色</font> <br />
                        型号：<font color="#999999">50ml</font>
                    </td>
                  ...
                  <tr valign="top">
                    <td width="160"><img src="{{asset('images')}}/peo4.jpg" width="20" height="20" align="absmiddle" />&nbsp;那*****洋 <br /><font color="#999999">（匿名用户）</font></td>
                    <td width="180">
                        颜色分类：<font color="#999999">粉色</font> <br />
                        型号：<font color="#999999">50ml</font>
                    </td>
