    ...
    <div class="content mar_10">
    	...
    	<div class="s_left">
            ...
            <ul class="p_sell">
                ...
                <li>
                	<div class="img"><img src="{{asset('images')}}/t2.jpg" width="160" height="140" /></div>
                ...
                <li>
                	<div class="img"><img src="{{asset('images')}}/t3.jpg" width="160" height="140" /></div>
                ...
                <li>
                	<div class="img"><img src="{{asset('images')}}/t4.jpg" width="160" height="140" /></div>
