...
<div class="i_bg">  
    ...
    <div class="content mar_20">
    	<table border="0" class="car_tab" style="width:1200px; margin-bottom:50px;" cellspacing="0" cellpadding="0">
          ...
          <tr class="car_tr">
            <td>
            	<div class="c_s_img"><img src="{{asset('images')}}/c_2.jpg" width="73" height="73" /></div>
                Rio 锐澳 水蜜桃味白兰地鸡尾酒（预调酒） 275ml
            </td>
            <td align="center">颜色：灰色</td>
            <td align="center">
          ...
          <tr>
            <td>
            	<div class="c_s_img"><img src="{{asset('images')}}/c_3.jpg" width="73" height="73" /></div>
                Rio 锐澳 水蜜桃味白兰地鸡尾酒（预调酒） 275ml
            </td>
            <td align="center">颜色：灰色</td>
            <td align="center">
          ...
          <tr class="car_tr">
            <td>
            	<div class="c_s_img"><img src="{{asset('images')}}/c_4.jpg" width="73" height="73" /></div>
                Rio 锐澳 水蜜桃味白兰地鸡尾酒（预调酒） 275ml
            </td>
            <td align="center">颜色：灰色</td>
            <td align="center">
          ...
          <tr valign="top" height="150">
          	<td colspan="6" align="right">
            	<a href="#"><img src="{{asset('images')}}/buy1.gif" /></a>&nbsp; &nbsp; <a href="#"><img src="{{asset('images')}}/buy2.gif" /></a>
            </td>
          </tr>
        </table>
