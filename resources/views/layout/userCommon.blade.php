    ...
    <div class="sou">
        ...
        <span class="fr">
            ...
            @elseif($user->isLogin == true)
                <span class="fl">欢迎<span style="color:red">{{ $user->username }}</span>登录</a>&nbsp; <a href="{{URL('register')}}" style="color:#ff4e00;">免费注册</a>&nbsp;|&nbsp;<a href="{{URL('order')}}">我的订单</a>&nbsp;|</span>
            @endif
                <span class="ss">
                <div class="ss_list">
                    <a href="#">收藏夹</a>
...
<div class="m_top_bg">
    <div class="top">
        <div class="m_logo"><a href="Index.html"><img src="{{asset('images')}}/logo1.png" /></a></div>
        <div class="m_search">
            <form>
    ...
    <div class="m_content">
        <div class="m_left">
            ...
            <div class="left_m">
                ...
                <ul>
                    <li><a href="{{URL('user/member')}}">我的会员</a></li>
                    <li><a href="{{URL('user/results')}}">我的业绩</a></li>
                    <li><a href="{{URL('user/commission')}}">我的佣金</a></li>
                    <li><a href="{{URL('user/cash')}}">申请提现</a></li>
                </ul>
            </div>
        </div>
@yield('content')
